      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            FlatButton(child: Text("play_url"),
            onPressed: () async => {
              SpotifySdk.play(spotifyUri: "https://open.spotify.com/track/3VUZLAnE17QSUJAzYxgVb1?si=uBEZ5FccQY6_jEtdOvUaTA")
            }),
            FlatButton(child: Text("queue"),
            onPressed: () async => {
              SpotifySdk.queue(spotifyUri: "https://open.spotify.com/track/3VUZLAnE17QSUJAzYxgVb1?si=uBEZ5FccQY6_jEtdOvUaTA")
            }),
