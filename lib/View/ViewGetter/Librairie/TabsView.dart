...
class TabsView {
  ...
  Widget generatePlaylist(
      int tabIndex,
      MapEntry<ServicesLister, PlatformsController> elem,
      Function onReorder,
      Function openPlaylist) {
    ...
    return FutureBuilder<List<Playlist>>(
        ...
        builder:
          ...
          if (snapshot.hasData) {
            ...
            finalWidget = Theme(
                key: PageStorageKey(
                    'TabBarView:' + ctrl.platform.name + ':Playlists'),
                data: ThemeData(
                ...
                child: Container(
                    ...
                    child: RefreshIndicator(
                        ...
                        onRefresh: () async {
                          List<Playlist> plays =
                              await ctrl.getPlaylists(refreshing: true);
                          this.state.setState(() {
                            playlists = plays;
                          });
                        },
                        child: ReorderableListView(
                            ...
                            children: List.generate(playlists.length, (index) {
                              return Container(
                                  key: ValueKey(
                                      'ReorderableListView:Playlists:$index'),
                                  margin: EdgeInsets.only(
                                  ...
                                  child: InkWell(
                                    ...
                                    Flexible(
                                        ...
                                        child: ListTile(
                                          title: Text(
                                              playlists.elementAt(index).name),
                                          ...
                                          subtitle: Text(playlists
                                                  ...
                                                  .toString() +
                                              " tracks"),
                                          onLongPress: () => playlistOption(
                                              ctrl,
                                              playlists.elementAt(index),
                                              index),
                                          onTap: () => openPlaylist(tabIndex,
                                              elem, playlists.elementAt(index)),
                                        )),
                                    Flexible(
                                        flex: 1,
                                        child: Container(
    ...
    try {
      ...
      showDialog(
          ...
          builder: (dialogContext) {
            return AlertDialog(
              title: Text("Application introuvble",
                  style: TextStyle(color: Colors.white)),
              content: Text(
                  "L'application n'est pas installé ou vous utilisez un appareil IOS"),
    ...
    return FutureBuilder<List<Track>>(
        ...
        builder: (BuildContext context, AsyncSnapshot<List<Track>> snapshot) {
          ...
          if (snapshot.hasData) {
            ...
            List<Widget> realTracks = List.generate(tracks.length, (index) {
              return Container(
                        ...
                        child: AspectRatio(
                          ...
                          child: new Container(
                            decoration: new BoxDecoration(
                              ...
                              image: NetworkImage(
                                  tracks.elementAt(index).imageUrl),
                            )),
                          ),
                        )),
                    subtitle: Text(tracks.elementAt(index).artist),
                    onLongPress: () => trackMainDialog(
                        ctrl,
                        tracks.elementAt(index),
                        ctrl.platform.playlists.indexOf(playlist)),
                    trailing: FractionallySizedBox(
                        heightFactor: 1,
                        child: InkWell(
                          child: Icon(Icons.more_vert),
                          onTap: () => trackMainDialog(
                              ctrl,
                              tracks.elementAt(index),
                              ctrl.platform.playlists.indexOf(playlist)),
                        )),
                  ...
                  child: Container(
                      ...
                      child: SingleChildScrollView(
                          ...
                          child: Column(children: [
                              ...
                              Container(
                                  ...
                                  child: ListTile(
                                      subtitle: Container(
                                        ...
                                        onChanged: (val) {
                                          setResearch(ctrl, playlist, val,
                                              tracks, trackMainDialog);
                                        },
                                      )),
                                      trailing: InkWell(
                            ...
                            Visibility(
                                visible: notResearch,
                                child: Column(children: listTracks)),
                            Visibility(
                                visible: !notResearch,
                                child: Column(
            ...
            content: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    child: FlatButton(
                      child: Text("Supprimer de la playlist",
                          style: TextStyle(color: Colors.white)),
                      onPressed: () {
                        Navigator.pop(dialogContext);
          ...
          return AlertDialog(
            ...
            content: Column(
              ...
              children: [
                Container(
                  child: FlatButton(
                    child: Text("Ajouter à SmartShuffle",
                        style: TextStyle(color: Colors.white)),
                    onPressed: () {
                      Navigator.pop(dialogContext);
                      choosePlaylistToAddTrack(
                ...
                () {
                  if (ctrl.platform.name !=
                      PlatformsLister
                          .platforms[ServicesLister.DEFAULT].platform.name) {
                    return Container(
                      child: FlatButton(
                        child: Text("Ajouter à $ctrlName",
                            style: TextStyle(color: Colors.white)),
                        onPressed: () {
                          Navigator.pop(dialogContext);
          ...
          return AlertDialog(
            ...
            content: SingleChildScrollView(
                child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: () {
                      allCards = List.generate(ctrl.platform.playlists.length,
                          (index) {
                        if (ctrl.platform.playlists[index].ownerId ==
                            ctrl.getUserInformations()['ownerId']) {
                          return Theme(
                              ...
                              child: Container(
                                  child: Card(
                                      child: ListTile(
                                title:
                                    Text(ctrl.platform.playlists[index].name),
                                leading: FractionallySizedBox(
                                    heightFactor: 0.8,
                                    child: AspectRatio(
                                      aspectRatio: 1,
                                      child: new Container(
                                        decoration: new BoxDecoration(
                                          ...
                                          fit: BoxFit.fitHeight,
                                          alignment: FractionalOffset.center,
                                          image: NetworkImage(ctrl.platform
                                              .playlists[index].imageUrl),
                                        )),
                                      ),
                                    )),
                                subtitle: Text(ctrl.platform.playlists[index]
                                        .getTracks()
                                        .length
                                        .toString() +
                                    " tracks"),
                                onTap: () {
                                  Navigator.pop(dialogContext);
                                  String id = ctrl.addTrackToPlaylist(
                                      index, track, false);
                                  if (id == null) {
                                    showDialog(
                                        context: this.state.context,
                                        builder: (dialogContext) {
                                          return AlertDialog(
                                            title: Text(
                                                "La musique existe déjà, voulez-vous quand même l'ajouter ?",
                                                style: TextStyle(
                                                    color: Colors.white)),
                                            actions: [
                                              FlatButton(
  ...
  removeFromPlaylist(PlatformsController ctrl, Track track, int playlistIndex,
    ...
    showDialog(
        ...
        builder: (dialogContext) {
          return AlertDialog(
            title: Text(
                "Êtes-vous sûr de vouloir supprimer $name de $playlistName ?",
                style: TextStyle(color: Colors.white)),
            actions: [
              FlatButton(
              ...
              FlatButton(
                ...
                onPressed: () {
                  Navigator.pop(dialogContext);
                  int trackIndex = ctrl.platform.playlists[playlistIndex]
                      .getTracks()
                      .indexOf(track);
                  this.state.setState(() {
  ...
  createPlaylist(PlatformsController ctrl) {
    String value = "Playlist " +
        ctrl.platform.name +
        " n°" +
        ctrl.platform.playlists.length.toString();
              ...
              FlatButton(
                ...
                onPressed: () {
                  ...
                  this.state.setState(() {
                    ctrl.addPlaylist(
                        name: value,
                        ownerId: ctrl.getPlatformInformations()['ownerId']);
                  });
                },
              )
            ],
  ...
  void removePlaylist(BuildContext context, PlatformsController ctrl,
        ...
        builder: (dialogContext) {
          return AlertDialog(
            title: Text("Supprimer $name ?",
                style: TextStyle(color: Colors.white)),
            content: Text(
                "Il ne sera plus possible de la récupérer après sa suppression !"),
            contentTextStyle: TextStyle(color: Colors.white),
            actions: [
              FlatButton(
  ...
  void renamePlaylist(BuildContext context, Playlist playlist) {
    ...
    showDialog(
        ...
        builder: (dialogContext) {
          return AlertDialog(
            title:
                Text("Renommer $name", style: TextStyle(color: Colors.white)),
  ...
  clonePlaylist(
      BuildContext context, PlatformsController ctrl, Playlist playlist) {
    String name = playlist.name;
    ...
    showDialog(
        ...
        builder: (dialogContext) {
          return AlertDialog(
            title: Text("Cloner $name dans SmartShuffle ?",
                style: TextStyle(color: Colors.white)),
            actions: [
              FlatButton(
                child: Text("Non", style: TextStyle(color: Colors.white)),
              ...
              FlatButton(
                ...
                onPressed: () {
                  ...
                  Playlist play;
                  this.state.setState(() {
                    play = PlatformsLister.platforms[ServicesLister.DEFAULT]
                  ...
                  if (play == null) {
                    showDialog(
                        ...
                        builder: (dialogContext) {
                          return AlertDialog(
                            title: Text("$name existe déjà dans SmartShuffle",
                                style: TextStyle(color: Colors.white)),
                            actions: [
                              FlatButton(
                                child: Text("Ok",
  ...
  mergePlaylist(
    ...
    String name = playlist.name;
    List<Widget> allCards;
    PlatformsController defaultCtrl =
        PlatformsLister.platforms[ServicesLister.DEFAULT];
    ...
    showDialog(
        ...
        builder: (dialogContext) {
          return AlertDialog(
            title: Text(
                "Choisissez une playlist avec laquelle vous souhaitez fusionner $name",
                style: TextStyle(color: Colors.white)),
            content: SingleChildScrollView(
                child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: () {
                      allCards = List.generate(
                          defaultCtrl.platform.playlists.length, (index) {
                        return Theme(
                            data: ThemeData(brightness: Brightness.dark),
                            child: Container(
                                child: Card(
                                    child: ListTile(
                              title: Text(
                                  defaultCtrl.platform.playlists[index].name),
                              leading: FractionallySizedBox(
                                  heightFactor: 0.8,
                                  child: AspectRatio(
                                    aspectRatio: 1,
                                    child: new Container(
                                      decoration: new BoxDecoration(
                                        ...
                                        fit: BoxFit.fitHeight,
                                        alignment: FractionalOffset.center,
                                        image: NetworkImage(defaultCtrl.platform
                                            .playlists[index].imageUrl),
                                      )),
                                    ),
                                  )),
                              subtitle: Text(defaultCtrl
                                      .platform.playlists[index]
                                      .getTracks()
                                      .length
                                      .toString() +
                                  " tracks"),
                              onTap: () {
                                ...
                                defaultCtrl.mergePlaylist(
                                    defaultCtrl.platform.playlists[index],
                                    playlist);
                              },
                            ))));
                      });
            ...
            content: Column(
              ...
              children: [
                ...
                (ctrl.platform.name != "SmartShuffle"
                    ? Container(
                        child: FlatButton(
                          child: Text("Fusionner la playlist",
                              style: TextStyle(color: Colors.white)),
                          onPressed: () {
                            Navigator.pop(dialogContext);
                ...
                Container(
                  child: FlatButton(
                    child: Text("Supprimer",
                        style: TextStyle(color: Colors.white)),
                    onPressed: () =>
                        removePlaylist(dialogContext, ctrl, playlist, index),
                  ),
                ),
                Container(
                  child: FlatButton(
